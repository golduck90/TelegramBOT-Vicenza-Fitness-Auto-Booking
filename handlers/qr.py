...
# Il server WellTeam NON comunica la scadenza del QR.
# TTL impostato dall'utente a 2 minuti.
QR_TTL_SECONDS = 120
...
async def _generate_and_send_qr(update: Update, context: ContextTypes.DEFAULT_TYPE, user: dict):
    ...
    caption = (
        ...
        f"⏱️ Valido *2 minuti* — mostralo al tornello!\n"
        f"🔄 Scaduto? Premi *Rigenera* qui sotto."
    )
